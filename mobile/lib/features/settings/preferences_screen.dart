...
class _PreferencesScreenState extends State<PreferencesScreen> {
  bool _connexionInhabituelle = true;
  bool _enCours = false;

  Future<void> _basculer(bool valeur) async {
    setState(() {
      _connexionInhabituelle = valeur;
      _enCours = true;
    });
    // TODO(etape 3) : PATCH /auth/me/preferences reel {connexion_inhabituelle: valeur}.
