...
export class DocumentResponseDto {
  ...
  @ApiPropertyOptional({
    ...
    description: 'Hash SHA-256 du PDF officiel (64 hex chars)',
  })
  hash_sha256: string | null;

  @ApiPropertyOptional({
    example: null,
    description: 'Hash de transaction Polygon (#22)',
  })
  transaction_hash: string | null;

  @ApiPropertyOptional({
    example: 'universites/.../qrcodes/2026/06/INUB-2026-0001-qr.png',
    description: 'Cle de stockage S3/R2 du QR code',
  })
  qr_code_url: string | null;

  @ApiPropertyOptional({
    example: 'universites/.../documents/2026/06/INUB-2026-0001.pdf',
    description: 'Cle de stockage S3/R2 du PDF',
  })
  pdf_url: string | null;
